...
Load and follow the **recall-first** skill from `skills/recall-first/SKILL.md`.
...
Load and follow the **argument-architect** skill from `skills/argument-architect/SKILL.md`.
...
Load and follow the **devils-advocate** skill from `skills/devils-advocate/SKILL.md`.
...
Load and follow the **editorial-review** skill from `skills/editorial-review/SKILL.md`.
