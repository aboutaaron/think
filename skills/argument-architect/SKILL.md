...
version: 1.1.0
description: Use when asked to "stress-test my argument", "find gaps in my thinking", "audit my reasoning", before publishing persuasive writing, or proactively after brainstorms. Maps the argument's logical chain, flags unstated assumptions and leaps, and prescribes one-sentence fixes — unlike devils-advocate, which attacks rather than repairs.
---
